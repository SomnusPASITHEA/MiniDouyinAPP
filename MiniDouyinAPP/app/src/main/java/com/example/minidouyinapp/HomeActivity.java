...
import com.example.minidouyinapp.Bean.Feed;
import com.example.minidouyinapp.Bean.FeedResponse;
import com.example.minidouyinapp.Bean.PostVideoResponse;
import com.example.minidouyinapp.newtork.IMinidouyinService;
import com.example.minidouyinapp.newtork.RetrofitManager;
import com.example.minidouyinapp.utils.ResourceUtils;
import com.example.minidouyinapp.R;
...
public class HomeActivity extends Activity {
    ...
    private String[] mPermissionArray = new String[]{Manifest.permission.CAMERA,
...
//        });
        ...
        addButton.setOnClickListener(new View.OnClickListener() {
             ...
             public void onClick(View v) {
                 ...
                 if (ContextCompat.checkSelfPermission(HomeActivity.this,
                     ...
                     ActivityCompat.requestPermissions(HomeActivity.this, mPermissionArray, PackageManager.PERMISSION_GRANTED);
                 }
    ...
    private boolean requestReadExternalStoragePermission(String explanation) {
        if (ActivityCompat.checkSelfPermission(HomeActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE) == PackageManager.PERMISSION_DENIED) {
...
//                Glide.with(iv.getContext()).load(url).into(iv);
                ...
                final String videoUrl = mFeeds.get(i).getVideo_url();
                iv.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {

                        /*
                        * TODO 在这里设置点击事件 跳转去播放界面*/
                        Intent intent = new Intent(HomeActivity.this,PlayVideoActivity.class);
                        intent.putExtra("videoUrl",videoUrl);
                        startActivity(intent);
                        Log.d("OnClick", "onClick: " + videoUrl);
                    }
                });
                Glide.with(iv.getContext()).load(url).into(iv);
            }
    ...
    public void fetchFeed(View view) {
        ...
        feedRetrofit.create(IMinidouyinService.class).fetchFeed().enqueue(new Callback<FeedResponse>(){
            ...
            public void onResponse(Call<FeedResponse> call, Response<FeedResponse> response) {
                ...
                mRv.getAdapter().notifyDataSetChanged();
                Log.d("RequestFeed", "onResponse: "+response.body().getFeeds().get(0).getImage_url());
